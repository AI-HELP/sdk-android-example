...
#### 2. Add Below Dependencies in the build.gradle of your APP or Module which intracts with AIHelp sdk:
	...
	dependencies {
	 ...
	    implementation 'net.aihelp:elva:1.5.1'
    ...
    }
...
Wait until the build.gradle sync completion and make sure there is no error during sync: Under the "External Libraries" folder of Android Studio Project sturcture view you should be able to find the folder "elva-1.5.1". If there is an error during sync or you can not find elva folder. Use the Method #2 below:
